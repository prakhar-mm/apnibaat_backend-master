    ...
    for script in scripts:
        ...
        if script == './data_gen_load/img_gen.py':
            ...
            for topic, article in data.items():
                ...
                proceed = st.button("Yes", key=f"proceed_{script}", help="Click 'Yes' to continue", style="background-color: green; color: white")
                abort = st.button("No", key=f"abort_{script}", help="Click 'No' to abort the execution",style="background-color: green; color: white")
