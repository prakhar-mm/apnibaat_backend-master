...
def generate_sentence(image_idea,keywords,ArticleAboutPeople):
    ...
    Prompt2 = f"{best_sentence}. Emphasize {keyword}, If using faces use Indian/North Indian/East Indian faces, realistic, Style: {random_style}, Lighting:{random_lighting}, Camara:{random_camara},  Material:{random_material}"
