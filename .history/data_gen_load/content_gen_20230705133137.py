...
def generate_article(topic):
    ...
    response_schemas = [
        ...
        ResponseSchema(name="keywords", description="keywords that define the article"),
        ResponseSchema(name="ArticleAboutPeople", description="True if article is about people otherwise false"),
    ...
    messages=[
        HumanMessagePromptTemplate.from_template("For Indian audiences write a 1000-word article on the topic: {topic}\n \
                                                    {format_instructions}\n{user_prompt}")
    ],
