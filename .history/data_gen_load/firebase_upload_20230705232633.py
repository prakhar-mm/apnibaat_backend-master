...
def push_data(language, data):
    ...
    # Convert the datetime to milliseconds
    milliseconds = int(year_2100.timestamp() * 1000)  # Generate a timestamp in milliseconds
    delta=milliseconds-timestamp
    ref.child(str(delta)).set(data)
