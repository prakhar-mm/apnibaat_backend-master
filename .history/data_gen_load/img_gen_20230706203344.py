...
for topic, article_data in data.items():
    ...
    image_idea = article_data["summary"]
    keywords, ArticleAboutPeople = analyze_text(content)
    ...
    try:
        ...
        article_data.update({"Image_url": image_url, "Slug": slug, "Image_source": image_source,"keywords":keywords,"ArticleAboutPeople":ArticleAboutPeople})
        new_data[topic] = article_data
