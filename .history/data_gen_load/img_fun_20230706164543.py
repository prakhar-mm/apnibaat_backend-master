...
def generate_sentence(title,keywords,ArticleAboutPeople):
    ...
    Prompt1 = f" {best_sentence}. Emphasize {keyword}, realistic and {random_style}, Lighting:{random_lighting}, Camara:{random_camara}, Material:{random_material}"
    Prompt2 = f"{best_sentence}. Emphasize {keyword}, If using faces use Indian/North Indian/East Indian faces, realistic and human resembling, avoid using hands, skintone can vary from white to brown,Style: {random_style}, Lighting:{random_lighting}, Camara:{random_camara},  Material:{random_material}"
...
url = f"{api_host}/v1/generation/stable-diffusion-xl-beta-v2-2-2/text-to-image"

def generate_image_dream_studio(prompt, output_name, output_folder=None,  width=512, height=512):
    headers = {
    ...
    data = {
        ...
        "steps": 50,
        "text_prompts": [
            {"text": """Design a detailed and vibrant digital illustration depicting the biodiversity of India for a birdwatching article. The image should incorporate the following:

A collage or panorama that combines the lush forests of the Western Ghats, the lofty peaks of the Himalayas, and the expansive wetlands of Bharatpur, to illustrate the diverse ecosystems across India.

Inset images of iconic bird species including the Indian Peacock, Himalayan Monal, Malabar Grey Hornbill, Nilgiri Wood Pigeon, Malabar Trogon, Cheer Pheasant, Black-necked Crane, Siberian Crane, Painted Stork, and Sarus Crane, scattered throughout the panorama to show the diversity of bird species.

Silhouettes of birdwatchers in the foreground, equipped with binoculars, representing the birdwatching community.

A person seen documenting or photographing birds, highlighting the conservation and research aspects of birdwatching.

Optionally, include subtle elements of a compass or a map to symbolize bird migration.

Remember, the illustration should be engaging, informative, and visually appealing, effectively enticing the audience to delve into the article about birdwatching in India.""", "weight": 0.5}
        ]
    }
