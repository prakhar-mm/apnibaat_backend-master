...
def generate_sentence(title,text):
    ...
    Prompt2 = f"{title}. {best_sentence}. Emphasize {keywords}, If using faces use Indian/North Indian/East Indian faces, realistic and human resembling, avoid using hands, skintone can vary from white to brown,Style: {random_style}, Lighting:{random_lighting}, Camara:{random_camara},  Material:{random_material}"
...
def generate_image_dream_studio(prompt, output_name, output_folder=None, engine_id="stable-diffusion-xl-beta-v2-2-2", width=512, height=512):
...
# Example usage
# generate_image_dream_studio("Arvind Kejriwal giving speech which realistic and has a view over his back", "output.png", "output_images")
