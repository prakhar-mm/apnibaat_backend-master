...
# Use only a text input for the topic and the number of articles to be generated.
topic = st.text_input('Type the topic/title for Article to be generated:')
num_of_articles = st.text_input(
    'Number of Article/s to be generated for each topic/title:')

# Create an object with the 'topic' as key
input_data = {topic: {'topic': topic, 'article_num': num_of_articles}}
