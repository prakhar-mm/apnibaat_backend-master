...
color_map = {
    'Entertainment': 'bg-color-teal-two',
    'News': 'bg-color-blue-two',
    'Food': 'bg-color-red-two',
    'Spirituality': 'bg-color-indigo-two',
    'Tourism': 'bg-color-green-two',
    'Gadgets': 'bg-color-purple-two',
    'Wellness': 'bg-color-gray-two',
    'Style': 'bg-color-pink-two',
    'Heritage': 'bg-color-brown-two',
    'Money': 'bg-color-yellow-two',
    'Jobs': 'bg-color-light-blue-two',
    'Business': 'bg-color-deep-orange-two',
    'Internet': 'bg-color-amber-two',
    'Cars': 'bg-color-cyan-two',
    'Games': 'bg-color-lime-two',
    'Exercise': 'bg-color-light-green-two',
    'Concerts': 'bg-color-teal-two',
    'Art': 'bg-color-indigo-two',
    'DIY': 'bg-color-blue-gray-two',
    'Nature': 'bg-color-green-two',
    'Gender': 'bg-color-pink-two',
    'Psychology': 'bg-color-gray-two',
    'Science': 'bg-color-blue-two',
    'Motivation': 'bg-color-indigo-two',
    'Family': 'bg-color-brown-two',
    'Mythology': 'bg-color-deep-orange-two',
    'Sustainability': 'bg-color-light-green-two',
    'Meditation': 'bg-color-indigo-two',
    'Books': 'bg-color-blue-gray-two',
    'Men': 'bg-color-pink-two',
    'Humor': 'bg-color-teal-two',
    'Television': 'bg-color-cyan-two',
    'Startups': 'bg-color-amber-two',
    'Bikes': 'bg-color-cyan-two',
    'Personality': 'bg-color-gray-two',
    'Mobiles': 'bg-color-purple-two',
    'Fashion': 'bg-color-pink-two',
    'Health': 'bg-color-gray-two',
    'Economy': 'bg-color-yellow-two',
    'Design': 'bg-color-indigo-two',
    'International': 'bg-color-blue-two',
    'Movies': 'bg-color-teal-two',
    'Finance': 'bg-color-yellow-two',
    'Minimalism': 'bg-color-blue-gray-two',
    'Travel': 'bg-color-green-two',
    'Reviews': 'bg-color-lime-two',
}
