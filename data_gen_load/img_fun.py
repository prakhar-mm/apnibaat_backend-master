...
def generate_sentence(summary,keywords,ArticleAboutPeople):
    ...
    Prompt1 = f" {best_sentence}. Emphasize {keyword}, realistic "
    Prompt2 = f"{best_sentence}. Emphasize {keyword}, If using faces use Indian/North Indian/East Indian faces, realistic"
